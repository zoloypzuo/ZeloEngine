...
fwrite(&numVertices,
sizeof(numVertices), 1, stream);   // Output number of verts
fwrite(&vertex[0],
sizeof(Point), numVertices, stream); // Output verts themselves
...
for (
int i = 0;
i < MAX_VERTICES; i++) triListHead[i] =
NULL;
