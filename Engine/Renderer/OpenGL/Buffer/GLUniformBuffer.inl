...
namespace Zelo {
template<typename T>
inline void UniformBuffer::SetSubData(const T &data, size_t offsetInOut) {
    Bind();
...
template<typename T>
inline void UniformBuffer::SetSubData(const T &data, std::reference_wrapper <size_t> offsetInOut) {
    Bind();
