...
void ForwardShadowRenderer::initializeShadowMap() {
    ...
    // shader
    m_simpleDepthShader = std::make_unique<GLSLShaderProgram>("Shader/3.1.1.shadow_mapping_depth.lua");
    m_simpleDepthShader->link();

    m_debugDepthQuad = std::make_unique<GLSLShaderProgram>("Shader/3.1.1.debug_quad.lua");
...
void ForwardShadowRenderer::renderScene(GLSLShaderProgram *shader) const {
    // floor
