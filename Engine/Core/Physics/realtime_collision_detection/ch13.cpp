...
int i = 0;
i < 1000; i++)
if (elem[i].value > elem[index].value)
index = i;
...
int i = 0;
i < 1000; i++)
if (elem1[i].value > elem1[index].value)
index = i;
// Increment the count field of that element
elem2[index].count++;
...
i < 4 *
n;
i += 4) { // Unrolled. Process and step 4 elements at a time
...
i++) {
Triangle *pCachedTri = &pCachedLeaf->triangle[i];
DoSomethingWithTriangle(pCachedTri
->p0, pCachedTri->p1, pCachedTri->p2);
}
...
...
00401154
cmp eax,
2; if (x == 2) goto RETURN_1
00401157   je          00401170
00401159
cmp eax,
3; if (x == 3) goto RETURN_1
0040115C   je          00401170
0040115E
cmp eax,
5; if (x == 5) goto RETURN_1
00401161   je          00401170
00401163
cmp eax,
7; if (x == 7) goto RETURN_1
00401166   je          00401170
00401168
cmp eax,
11; if (x == 11) goto RETURN_1
