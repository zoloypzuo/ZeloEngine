...
local function healthdelta(inst, data)
    --Changes health (For the better! We don't want the player to die from this)
    local tar = data.doer or data.worker
...
local function inventorydelta(inst, data)
    --Does some sort of effect on an item in your inventory
    local tar = data.doer or data.worker
