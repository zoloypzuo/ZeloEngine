local quakelevels = {
    level1 = {
        ...
        quaketime = function()
            return math.random(5, 10) + 5
        end, --how long the quake lasts
        debrispersecond = function()
            return math.random(5, 6)
        end, --how much debris falls every second
        nextquake = function()
            return TUNING.TOTAL_DAY_TIME * 0.5 + math.random() * TUNING.TOTAL_DAY_TIME
        end    --how long until the next quake
    },

    level2 = {
        prequake = 6,
        quaketime = function()
            return math.random(7, 12) + 5
        end,
        debrispersecond = function()
            return math.random(6, 7)
        end,
        nextquake = function()
            return TUNING.TOTAL_DAY_TIME * 2 + math.random() * TUNING.TOTAL_DAY_TIME * 1
        end
    },
    ...
    level3 = {
        prequake = 5,
        quaketime = function()
            return math.random(10, 15) + 5
        end,
        debrispersecond = function()
            return math.random(7, 8)
        end,
        nextquake = function()
            return TUNING.TOTAL_DAY_TIME * 1 + math.random() * TUNING.TOTAL_DAY_TIME * 1
        end
    },
    ...
    level4 = {
        prequake = 4,
        quaketime = function()
            return math.random(12, 17) + 5
        end,
        debrispersecond = function()
            return math.random(8, 9)
        end,
        nextquake = function()
            return TUNING.TOTAL_DAY_TIME * 1 + math.random() * TUNING.TOTAL_DAY_TIME * 0.5
        end
    },
    ...
    tentacleQuake = { -- quake during tentacle pillar death throes
        prequake = -3, --the warning before the quake
        quaketime = function()
            return GetRandomWithVariance(3, .5)
        end, --how long the quake lasts
        debrispersecond = function()
            return GetRandomWithVariance(20, .5)
        end, --how much debris falls every second
        nextquake = function()
            return TUNING.TOTAL_DAY_TIME * 100
        end, --how long until the next quake
    },
}
...
function Quaker:MiniQuake(rad, num, duration, target)
    ...
    self.inst:DoTaskInTime(duration, function()
        self.inst.SoundEmitter:KillSound("miniearthquake")
    end)
end
