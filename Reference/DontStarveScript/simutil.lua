...
function GetClock()
    if GetWorld() and GetWorld().components then
        return GetWorld().components.clock
    end
end
function GetNightmareClock()
    if GetWorld() and GetWorld().components then
        return GetWorld().components.nightmareclock
    end
end
function GetSeasonManager()
    if GetWorld() and GetWorld().components then
        return GetWorld().components.seasonmanager
    end
end
function GetMoistureManager()
    if GetWorld() and GetWorld().components then
        return GetWorld().components.moisturemanager
    end
end
