...
local states = {
    ...
    State {
        ...
        timeline = {
            TimeEvent(20 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/worm/eat")
            end),
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.components.lighttweener:StartTween(nil, 0, nil, nil, nil, .66, function(inst, light)
                if light then
                    light:Enable(false)
                end
            end)
    ...
    State {
        ...
        timeline = {
            TimeEvent(0 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/worm/dirt")
            end),
            TimeEvent(10 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/worm/dirt")
            end),
    ...
    State {
        ...
        timeline = {
            TimeEvent(1 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/worm/lure_emerge")
            end),
        },
    ...
    State {
        ...
        timeline = {
            TimeEvent(1 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/worm/lure_retract")
            end),
        },
