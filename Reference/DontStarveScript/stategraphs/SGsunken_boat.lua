...
local states = {
    ...
    State {
        ...
        timeline = {
            TimeEvent(6 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("dontstarve/creatures/teasertheparrot/peck")
            end),
    ...
    State {
        ...
        timeline = {
            ...
            TimeEvent(06 * FRAMES, function(inst)
...
CommonStates.AddSleepStates(states,
        {
            starttimeline = {
                TimeEvent(0 * FRAMES, function(inst)
                    inst.SoundEmitter:PlaySound("dontstarve/creatures/teasertheparrot/sleep")
                end),
            },
            sleeptimeline = {
                TimeEvent(0 * FRAMES, function(inst)
