...
local Any = {
    ...
    ["GrassBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            ...
            resource_area = function()
                return PickSomeWithDups(math.random(3, 5), { "grass" })
            end,
        },
    }),
    ...
    ["Level2WoodBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            item_area = function()
                return PickSome(1, { "armorwood", "axe" })
            end,
            resource_area = function()
                return PickSomeWithDups(math.random(3, 5), { "boards" })
            end,
        },
    }),
    ["Level2RockBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            ...
            resource_area = function()
                return PickSomeWithDups(math.random(3, 5), { "cutstone" })
            end,
        },
    }),
    ["Level2GrassBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            ...
            resource_area = function()
                return PickSomeWithDups(math.random(3, 5), { "rope" })
            end,
        },
    }),
    ...
    ["MiscBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            item_area = function()
                return PickSome(1, { "winterhat", "tophat", "bushhat", "featherhat", "trunkvest_winter", "trunkvest_summer",
                                     "cane", "sweatervest" })
            end,
            resource_area = function()
                return nil
    ...
    ["WeaponBoon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            item_area = function()
                return PickSome(1, { "blowdart_sleep", "blowdart_fire", "blowdart_pipe", "boomerang" })
            end,
            resource_area = function()
                return nil
            end,
...
local Rare = {
    ...
    ["Level4Boon"] = StaticLayout.Get("map/static_layouts/small_boon", {
        areas = {
            item_area = function()
                return PickSome(1, { "firestaff", "icestaff", "armormarble", "panflute", "cane", "hambat", "nightsword", "onemanband" })
            end,
            resource_area = function()
                return nil
            end,
