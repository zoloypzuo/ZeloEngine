...
-- make environment（创建沙箱环境）
local env = {  -- add functions ou know are safe here（你可以添加你信任的函数在这里）
    loadstring = loadstring -- functions can get serialized to text, this is required to turn them back into functions（废话）
}
