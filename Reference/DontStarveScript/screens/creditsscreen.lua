...
local CreditsScreen = Class(Screen, function(self)
    ...
    if not TheInput:ControllerAttached() then
        ...
        if PLATFORM ~= "PS4" then
            ...
            self.FB_button:SetOnClick(function()
                VisitURL("http://facebook.com/kleientertainment")
            end)
            ...
            self.TWIT_button:SetOnClick(function()
                VisitURL("http://twitter.com/klei")
            end)
            ...
            self.THANKS_button:SetOnClick(function()
                VisitURL("http://www.dontstarvegame.com/Thank-You")
            end)
