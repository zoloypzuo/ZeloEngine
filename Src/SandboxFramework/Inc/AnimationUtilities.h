...
public:
	...
	static void SetDebugSkeleton(
		Ogre::Entity& entity, Ogre::SceneManager& manager, bool enable);
	...
	static void SetEnable(
		Ogre::AnimationState& animation, bool enable);

	static void SetLooping(
		Ogre::AnimationState& animation, bool enable);

	static void SetNormalizedTime(
		Ogre::AnimationState& animation, Ogre::Real normalizedTime);

	static void SetTime(
		Ogre::AnimationState& animation, Ogre::Real time);

	static void SetWeight(
		Ogre::AnimationState& animation, Ogre::Real weight);

	static void StepAnimation(
		Ogre::AnimationState& animation,
		Ogre::Real deltaTimeInMillis);
